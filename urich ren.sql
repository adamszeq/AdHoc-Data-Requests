...
,homerenewal.StreetName as StreetName
	,homerenewal.Town as Town
	,homerenewal.TownCode as TownCode
	,homerenewal.County as County
	,homerenewal.CountyCode as CountyCode
,homerenewal.membershipPenetration as AA_Membership_Discount
